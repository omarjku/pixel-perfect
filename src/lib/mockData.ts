...
// ── MOCK API CLIENT ─────────────────────────────────────────────────────────
// Every function is a placeholder for a real backend call. Comments mark the
// endpoint each call should hit once the API is live.
...
// TODO: Replace with real endpoint — POST /api/sessions
